...
train_info_coco_sampled = pickle.load(open('./class_to_imageid_and_inscount_coco_sampled.pt', 'rb'))
train_cls_label_to_info_coco = {item['category_id']: item['isntance_count'] for item in train_info_coco_sampled.values()}
# lessthan100clsid_coco = [k for i,(k,v) in enumerate(train_cls_label_to_info_coco.items()) if v<100]
# lessthan400clsid_coco = [k for i,(k,v) in enumerate(train_cls_label_to_info_coco.items()) if v<400]
